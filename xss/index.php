		...
		<FORM METHOD=POST ACTION="echo.php">
			<table width="80%" border="0" cellpadding="3" cellspacing="3" bgcolor="#FFFFFF">
				...
				<tr>
					...
					<label for="httponly" name="httponly" class="css-lbl">HTTPOnly</label></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>
					<input name="secure" type="checkbox" class="css-cb" id="secure">
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td>
					<input name="csp" type="checkbox" class="css-cb" id="csp">
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td>
					<input name="xssP" type="checkbox" class="css-cb" id="xssP">
